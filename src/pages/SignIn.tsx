        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 border border-border bg-card hover:bg-accent/50 text-foreground font-medium transition-colors duration-200 rounded-md px-4 py-2.5 shadow-sm hover:shadow-md"
            >
