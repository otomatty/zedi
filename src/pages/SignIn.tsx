        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-md border border-border bg-card px-4 py-2.5 font-medium text-foreground shadow-sm transition-colors duration-200 hover:bg-accent/50 hover:shadow-md"
            >
