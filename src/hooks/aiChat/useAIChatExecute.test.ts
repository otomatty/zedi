...
import { streamAssistantCompletion } from "@/hooks/aiChat/useAIChatExecuteHelpers";
import { executeSendMessage, executeRegenerateAssistant } from "@/hooks/aiChat/useAIChatExecute";
...
vi.mock("@/hooks/aiChat/useAIChatExecuteHelpers", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@/hooks/aiChat/useAIChatExecuteHelpers")>();
  return {
    ...actual,
