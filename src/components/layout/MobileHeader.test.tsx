/**
 * MobileHeader: compact h-16 title bar that shows ONLY the search bar inline.
 ...
 * to the bottom nav.
 *
 * モバイルヘッダー: h-16 のタイトルバーに検索バーのみをインラインで描画する。
...
describe("MobileHeader", () => {
  it("renders a compact h-16 sticky title bar", () => {
