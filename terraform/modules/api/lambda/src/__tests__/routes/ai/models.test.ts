...
const MOCK_MODELS = [
  { id: 'm1', provider: 'openai', model_id: 'gpt-4o-mini', display_name: 'GPT-4o Mini', tier_required: 'free', is_active: true, sort_order: 1 },
  { id: 'm2', provider: 'openai', model_id: 'gpt-4o', display_name: 'GPT-4o', tier_required: 'pro', is_active: true, sort_order: 2 },
];
...
describe('AI Models API', () => {
  ...
  beforeEach(() => {
    ...
    mockDb.then.mockImplementation(
      (r?: ((v: unknown) => unknown) | null) => Promise.resolve(MOCK_MODELS).then(r),
    );
  });
  ...
  it('works without authentication', async () => {
    mockAuthOptional.mockImplementationOnce(
